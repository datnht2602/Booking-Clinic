...
using TextStyle = QuestPDF.Infrastructure.TextStyle;
...
public class InvoiceDocument : IDocument
{
    ...
    public DocumentMetadata GetMetadata()
    {
        ...
        result.Title = "Invoice By Young Blood Clinic";
        result.Author = "Derek Nguyen";
            ...
            .Row(row =>
            {
                ...
                row.RelativeItem()
                    .Row(r =>
                    {
                        r.RelativeItem()
                        .AlignLeft()
                        .Text($"Date of birth: {customer.Dob}", customerStyle);
    ...
    void ComposeBarCode(IContainer container)
    {
        ...
        {
            col.Item()
            .Text($"Voucher number {invoice.Coupon}",
