...
namespace Clinic.Caching
{
    public class DistributedCacheService : IDistributedCacheService
    {
        ...
        public async Task AddOrUpdateCacheAsync<T>(string cacheEntityKey, T cacheEntity, TimeSpan? absoluteExpiration = null, CancellationToken cancellationToken = default)
        {
            ...
            await this.distributedCache.SetAsync(cacheEntityKey, byteValue, distributedCacheEntryOptions.SetAbsoluteExpiration(absoluteExpiryTime),cancellationToken).ConfigureAwait(false);
        }
